        ...
        <Grid container direction="column">
                    ...
                    <Grid item container direction="column" md >
                        ...
                        <Grid item>
                            <Typography variant="body1" align={matchesSM ? "center" : "right"} paragraph>
                                Whether you’re a large brand, just getting started, or taking off right now, our application architecture ensures pain-free growth and reliability.                            </Typography>
                        </Grid>
                    </Grid>
                </Grid>
            </Grid>
            ...
            >
                <Grid item container direction="column" alignItems="center">
                    <Grid item>
                        <img src={roots} alt="roots" height={matchesSM ? "300em" : "450em"}
                ...
                >
                    <Grid item container direction="column" md >
                        ...
                        <Grid item>
                            ...
                            <Typography variant="body1" align={matchesSM ? "center" : undefined} paragraph>
                                Increasing efficiency increases profits, leaving you more time to focus on your business, not busywork.                            </Typography>
                        </Grid>
                    </Grid>
                    <Grid item md>
