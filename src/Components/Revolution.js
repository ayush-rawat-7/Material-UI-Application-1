    ...
    return (
        <Grid container direction="column">
            ...
            >
                ...
                <Grid item container lg justifyContent={matchesMD ? "center" : "flex-end"} >
            ...
            >
                <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant="h4" style={{ color: "#000", marginTop: "5em" }} gutterBottom>
                            Consultation
                        </Typography>
                    </Grid>
                    <Grid item>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }} >
                    <img src={review} width="100%" alt="magnifying" />
                </Grid>
            </Grid>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }} >
                    <img src={design} width="100%" style={{ maxWidth: 1000 }} alt="paint brush leaving stroke of paint" />
                </Grid>
            </Grid>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }} >
                    <img src={build} width="100%"  style={{ maxWidth: matchesMD ? 700 : 1000 }} alt="construction site" />
                </Grid>
            </Grid>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }} >
                    <img src={launch} width="100%" style={{ maxWidth: 200 }} alt="space ship" />
                </Grid>
            </Grid>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }} >
                    <img src={maintain} width="100%" style={{ maxWidth: 500 }} alt="screw driver" />
                </Grid>
            </Grid>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }} >
                    <img src={iterate} width="100%" alt="domino falling" />
                </Grid>
            </Grid>
